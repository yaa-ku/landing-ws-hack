...
import s from './best_students.module.scss'
...
export const BestStudents = () => {
    ...
    return (
        <div className={s['best_students_block']}>
            <div>
                <h3 className={s['block_title']}>Лучшие студенты</h3>
            </div>
            <div>
                <div className={s['best_students_block_list']}>
